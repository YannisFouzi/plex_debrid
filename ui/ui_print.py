...
def logo(path='',update=""):
    print('                                                         ')
    print('           __                  __     __         _     __')
    print(r'    ____  / /__ __  __    ____/ /__  / /_  _____(_)___/ /')
    print(r'   / __ \/ / _ \| |/_/   / __  / _ \/ __ \/ ___/ / __  / ')
    print(r'  / /_/ / /  __/>  <    / /_/ /  __/ /_/ / /  / / /_/ /  ')
    print(r' / ____/_/\___/_/|_|____\____/\___/_____/_/  /_/\____/   ')
    print('/_/               /_____/                         [v' + ui_settings.version[0] + ']' + update)
    print()
    print('    _____ ____                ____  __         ')
    print(r'   / ____/ __ \__  __ ___  (_) __ \/ /__ __  __')
    print(r'  / /_  / / / / / / /_  / / / /_/ / / _ \| |/_/')
    print(r' / __/ / /_/ / /_/ / / /_/ / ____/ /  __/>  <  ')
    print(r'/_/    \____/\____/ /___/_/_/   /_/\___/_/|_|  ')
