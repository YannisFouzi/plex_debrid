...
def logo(path='',update=""):
    print('                                                         ')
    print('           __                  __     __         _     __')
    print('    ____  / /__ __  __    ____/ /__  / /_  _____(_)___/ /')
    print('   / __ \/ / _ \| |/_/   / __  / _ \/ __ \/ ___/ / __  / ')
    print('  / /_/ / /  __/>  <    / /_/ /  __/ /_/ / /  / / /_/ /  ')
    print(' / ____/_/\___/_/|_|____\____/\___/_____/_/  /_/\____/   ')
    print('/_/               /_____/                         [v' + ui_settings.version[0] + ']' + update)
    print()
    print('    _____ ____                ____  __         ')
    print('   / ____/ __ \__  __ ___  (_) __ \/ /__ __  __')
    print('  / /_  / / / / / / /_  / / / /_/ / / _ \| |/_/')
    print(' / __/ / /_/ / /_/ / / /_/ / ____/ /  __/>  <  ')
    print('/_/    \____/\____/ /___/_/_/   /_/\___/_/|_|  ')
